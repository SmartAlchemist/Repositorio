<%-- 
    Document   : actualizar
    Created on : 30/10/2021, 6:05:17 p. m.
    ...
    <body id="PaginaInicio">
        ...
        <main class="mb-4" id="InicioSesion">
            <form>
                ...
                <div class="mb-3"><h5>Para cambiar su contraseña, envie su usuario</h5></div>
                ...
                <div class="mb-3">
                  ...
                  <div class="form-check" id="box">
                    <input class="form-check-input" type="checkbox" value="" id="check" onchange="validar()">
                ...
                <div class="mb-3" id="validar">
                  ...
                  <br>
                  <label for="contraseña02" class="form-label">Comfirmar contraseña</label>
                  <input type="password" class="form-control" id="contraseña02" name="contraseña02" required>
                  <button type="submit" class="btn btn-primary" id="boton" onsubmit="redireccionar()">Cambiar contraseña</button>
                </div>
